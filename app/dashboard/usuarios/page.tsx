        ...
        <div className="relative mx-auto max-w-7xl px-6 py-10 lg:px-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div>
              <div className="mb-4 flex items-center gap-2">
                <span className="rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs font-medium text-white/80 backdrop-blur">Administración</span>
                <span className="h-1 w-1 rounded-full bg-white/40" />
                <span className="text-xs text-white/60">Panel de control</span>
              </div>
              <h1 className="text-3xl font-bold tracking-tight text-white md:text-4xl">Usuarios</h1>
              <p className="mt-2 max-w-2xl text-sm leading-6 text-white/70 md:text-base">Administra las cuentas, planes, estados y acceso de los clientes de Colibrí.</p>
            </div>
            {/* Acción */}
            <CreateUserButton />
          </div>
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
              <p className="text-xs font-medium uppercase tracking-wider text-white/50">Usuarios</p>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-medium uppercase tracking-wider text-white/50">Activos</p>
              </div>
              <p className="mt-2 text-2xl font-bold text-white">{activeUsers}</p>
            </div>
            {/* PRO */}
            <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
              <p className="text-xs font-medium uppercase tracking-wider text-white/50">Plan PRO</p>
              <p className="mt-2 text-2xl font-bold text-white">{proUsers}</p>
            </div>
            {/* BASIC */}
            <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
              <p className="text-xs font-medium uppercase tracking-wider text-white/50">Plan BASIC</p>
              <p className="mt-2 text-2xl font-bold text-white">{basicUsers}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-1 text-xl font-bold text-slate-800">Cuentas registradas</h2>
            <p className="mt-1 text-sm text-slate-500">Administra el acceso y las características disponibles para cada usuario.</p>
          </div>
        ...
        <div className="mt-5 flex items-start gap-3 rounded-xl border border-[#DCE7DF] bg-[#F3F7F4] px-4 py-3">
          <span className="mt-0.5 text-[#2F5D50]">ⓘ</span>
          <p className="text-xs leading-5 text-[#62756A]">Los cambios de plan y estado se aplican inmediatamente. Los permisos disponibles para cada usuario dependen de su plan actual.</p>
        </div>
      </div>
    </main>
  )
