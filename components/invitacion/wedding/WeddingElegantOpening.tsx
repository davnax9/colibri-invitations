...
export default function WeddingElegantOpening({
  brideName,
  groomName,
  eventDate,
  children,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 45%, var(--theme-secondary), transparent 60%)",
          opacity: 0.07,
        }}
      />
      ...
      <div
        className={`absolute left-1/2 top-8 -translate-x-1/2 text-center transition-all duration-1000 ${
          isOpening
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-10 text-center">
            ...
            <p
              className="mt-7 font-serif text-2xl italic"
              style={{
            ...
            <div className="mt-7">
              <h1
                className="font-serif text-5xl font-light leading-none md:text-6xl"
                style={{
                  color: "var(--theme-primary)",
                }}
              >
            ...
            <div className="relative mt-9">
              ...
              <button
                ...
                className={`wedding-elegant-seal relative flex h-16 w-16 items-center justify-center rounded-full border-2 transition-all duration-500 md:h-[70px] md:w-[70px] ${
                  isOpening
                    ? "scale-75 opacity-0"
          ...
          <div
            className="absolute left-7 top-1/2 hidden -translate-y-1/2 text-sm md:block"
            style={{
              color: "var(--theme-accent)",
            }}
          >
          ...
          <div
            className="absolute right-7 top-1/2 hidden -translate-y-1/2 -scale-x-100 text-sm md:block"
            style={{
              color: "var(--theme-accent)",
            }}
          >
