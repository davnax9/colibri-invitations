      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-16 space-y-6">
          {schedules.map((schedule, index) => (
            <div
              key={schedule.id}
              className="group relative overflow-hidden rounded-2xl border transition duration-300 hover:-translate-y-1 hover:shadow-lg"
              style={{
            ...
            >
              ...
              <div className="grid md:grid-cols-[130px_1fr]">
                ...
                {/* NÚMERO */}
                <div
                  className="flex items-center justify-center p-6 md:border-r"
                  style={{
                    borderColor: "var(--theme-accent)",
                  }}
                >
