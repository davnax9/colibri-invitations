          ...
          <section className="relative min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-6 text-center">
              <div className="max-w-xl">
                ...
                <h1 className="font-serif text-6xl font-light text-[#405047]">
                  {childName}
                </h1>

                <p className="mt-6 font-serif text-lg italic text-green-700/80">
                ...
                {event.details?.phrase && (
                  <p className="mt-10 text-sm italic leading-6 text-[#68776e]">
                    "{event.details.phrase}"
                  </p>
                )}
              </div>
          ...
          {event.details?.description && (
            <section className="px-6 py-24 text-center">
              <div className="mx-auto max-w-2xl">
                ...
                <h2 className="mt-4 font-serif text-3xl text-[#405047]">
                  Con mucho amor
                </h2>

                <p className="mt-6 text-sm leading-7 text-[#68776e]">
                  {event.details.description}
                </p>

                <span className="mt-8 block text-3xl text-green-600/60">
                  ❦
                </span>
              </div>
            </section>
