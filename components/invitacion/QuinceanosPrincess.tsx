    ...
    <InvitationTheme theme={event.theme}>
      ...
      >
        ...
        {details?.phrase && (
          ...
          >
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p
                className="mt-6 font-serif text-3xl italic leading-relaxed md:text-4xl"
                style={{
        ...
        >
          ...
          >
            Guarda la fecha en tu calendario y acompáñame
            a celebrar este momento inolvidable.
          </p>

          <div className="mt-8">

            <AddToCalendar
              title={quinceaneraName || event.name}
