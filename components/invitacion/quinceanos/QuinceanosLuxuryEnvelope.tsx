  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, var(--theme-primary) 0%, transparent 55%)",
          opacity: 0.12,
        }}
      />
      ...
      <div
        className={`pointer-events-none absolute left-5 top-1/2 h-40 w-px -translate-y-1/2 transition-all duration-1000 ${
          isOpening
      ...
      <div
        className={`pointer-events-none absolute right-5 top-1/2 h-40 w-px -translate-y-1/2 transition-all duration-1000 ${
          isOpening
            ? "translate-x-8 opacity-0"
            : "opacity-40"
        }`}
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center px-6">
        ...
        >
          {/* SOMBRA */}
          <div
            className="absolute -bottom-8 left-1/2 h-10 w-[78%] -translate-x-1/2 rounded-full blur-2xl"
            style={{
          ...
          {/* BASE */}
          <div
            className="relative aspect-[1.45/1] overflow-hidden rounded-sm border shadow-2xl"
            style={{
              backgroundColor: "var(--theme-primary)",
          ...
          >
            ...
            {/* TARJETA CENTRAL */}
            <div
              className={`absolute inset-x-[14%] bottom-[12%] top-[12%] flex items-center justify-center border shadow-xl transition-all duration-1000 ${
                isOpening
                  ? "-translate-y-12 scale-105"
            ...
            >
              ...
              {/* LÍNEA DECORATIVA */}
              <div
                className="absolute left-1/2 top-[72%] h-px w-16 -translate-x-1/2"
                style={{
                  backgroundColor: "var(--theme-accent)",
                }}
              />
            ...
            <div className="pointer-events-none absolute inset-0 z-30 flex items-center justify-center">
              <button
                ...
                className={`pointer-events-auto flex h-20 w-20 items-center justify-center rounded-full border-2 shadow-xl transition-all duration-500 ${
                  isOpening
                    ? "scale-75 opacity-0"
