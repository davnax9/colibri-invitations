                ...
                {event.schedules.map((schedule, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {isLeft && (
                          <TimelineContent schedule={schedule} />
                        )}
                      </div>
                      ...
                      {/* PUNTO CENTRAL */}
                      <div
                        className="absolute left-1/2 top-1/2 flex h-4 w-4 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-2"
                        style={{
                          backgroundColor:
...
function TimelineContent({
  ...
  schedule: InvitationScheduleProps["event"]["schedules"][number]
}) {
  return (
    <div className="py-2">
      {/* HORA */}
