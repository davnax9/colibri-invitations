          ...
          <section className="relative min-h-screen overflow-hidden bg-[#faf8f3]">
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-6 text-center">
              ...
              <div className="w-full max-w-xl border border-[#c9a86a]/60 px-8 py-20 sm:px-16">
                ...
                <p className="mt-10 text-xs uppercase tracking-[0.35em] text-[#8d7140]">
                  Mi Primera Comunión
                </p>

                <h1 className="mt-6 font-serif text-5xl font-light text-stone-700">
                  {childName}
                </h1>
          ...
          {event.details?.description && (
            <section className="px-6 py-24 text-center">
              <div className="mx-auto max-w-2xl">
                ...
                <p className="text-xs uppercase tracking-[0.35em] text-[#8d7140]">
                  Un día de fe
                </p>
                ...
                <p className="mt-7 text-sm leading-8 text-stone-500">
                  {event.details.description}
                </p>
              </div>
            </section>
            ...
            <section className="px-6 py-24">
              ...
              <div className="mx-auto max-w-4xl">
                ...
                <div className="mb-14 text-center">
                  <p className="text-xs uppercase tracking-[0.3em] text-[#8d7140]">
                    Celebremos juntos
                  </p>
