...
export default function ComunionElegantHero({
  childName,
  coverPhoto,
}: Props) {
  return (
    ...
    >
      ...
      <div className="relative z-10 px-6 text-center">
        ...
        <p
          className="text-4xl font-serif md:text-6xl"
          style={{
        ...
        <p
          className="mt-2 text-4xl font-serif md:text-6xl"
          style={{
            color: "var(--theme-primary)",
          }}
        >
        ...
        <h1
          className="mt-8 text-4xl font-serif md:text-6xl"
          style={{
            color: "var(--theme-primary)",
          }}
        >
