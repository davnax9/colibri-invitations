          ...
          <div className="relative flex items-start justify-between">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-[#D7E3DE]">
                Proporciónanos tu correo y te ayudaremos a recuperar
            ...
            <button
              type="button"
              onClick={onClose}
              className="ml-4 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/10 text-xl transition hover:bg-white/20"
            >
              ×
            </button>
        ...
        >
          ...
          <div className="rounded-2xl bg-[#FAF8F3] p-4">
            ...
            <p className="mt-1 text-xs leading-5 text-[#687A72]">
              Se abrirá WhatsApp para solicitar asistencia. Nuestro
              administrador podrá verificar tu cuenta y ayudarte a
              recuperar el acceso.
            </p>
